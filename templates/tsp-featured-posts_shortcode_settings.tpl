<p>Changing the default post options allows you to place <strong>[tsp-featured-posts]</strong> shortcode tag into any post or page with the default options.</p>
