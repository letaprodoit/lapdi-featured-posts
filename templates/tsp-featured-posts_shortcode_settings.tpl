 <div class="tsp_container">
	...
	<div class="mycomment">
		...
		<div class="note-details">
			<ul style="list-style-type:square;">
				...
				<li>However, if you wish to add different options to the <strong>[tsp-featured-posts]</strong> shortcode please use the following settings:
					<ul style="padding-left: 30px;">
						...
						<li>Excerpt Length: <strong>excerpt_length="100"</strong></li>
			...
			<strong>[tsp-featured-posts title="Title of Posts" show_quotes="N" show_text_posts="N" number_posts="5" excerpt_length="100" post_ids="5,3,4" category="0" slider_width="865" slider_height="365 layout="0" order_by="DESC" thumb_width="80" thumb_height="80" before_title="" after_title=""]</strong>
		</div>
